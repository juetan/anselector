...
classes.has = function (name) {
  return this.__.el?.classList.contains(name) ?? false
}

classes.set = function (name) {
  return this.__.each(i => (i.className = name))
}

classes.toggle = function (name) {
  return this.__.each(i => i.classList.toggle(name))
}

classes.remove = function (name) {
  return this.__.each(i => i.classList.remove(name))
}
